...
import '../controller/HandoverShipmentController.dart';

class TobeShippedDetailScreen extends StatefulWidget {

  late SvgPicture picture;

  @override
  _TobeShippedDetailScreenState createState() => _TobeShippedDetailScreenState();
}


class _TobeShippedDetailScreenState extends State<TobeShippedDetailScreen>  {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => handoverShipmentController.isLoading.value
        ...
        : SafeArea(
            ...
            child: Column(
              children: [
                ///-------------------- Action Bar ------------------
                ActionBar(title: handoverShipmentController.orderId.value),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(handoverShipmentController.agentName.value,
                                            style: TextStyle(
                                              fontFamily:
                                      ...
                                      Padding(
                                        ...
                                        child: Text(handoverShipmentController.docketNumber.value,
                                            style: TextStyle(
                                              fontFamily:
                                                  ConstantFonts.poppinsMedium,
                                              fontSize: SizeConfig.defaultSize *
                                      ...
                                      Padding(
                                        ...
                                        child: Text(handoverShipmentController.brnNumber.value,
                                            style: TextStyle(
                                              fontFamily:
                                                  ConstantFonts.poppinsMedium,
                                              fontSize: SizeConfig.defaultSize *
  ...
  Future captureAgentImage(ImageSource source) async {
    ...
    if (this.mounted) {
      setState(() {
        handoverShipmentController.agentImgFile = File(imageFile!.path);
        imagePicked = true;
  ...
  Widget getAgentImage(){
      return ClipOval(
          child: Image.file(
            handoverShipmentController.agentImgFile,
