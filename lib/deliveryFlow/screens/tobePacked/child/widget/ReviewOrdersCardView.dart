...
import '../../../../../managerFlow/screen/deliveryOrders/child/newOrders/child/child/view/child/ReviewOrderItemsScaffold.dart';
import '../../../../../res/Dimens.dart';
import '../../../../../utils/SizeConfig.dart';
import '../controller/ReviewOrdersController.dart';

class ReviewOrdersView extends StatefulWidget {
  ReviewOrdersView(
  ...
  @override
  State<ReviewOrdersView> createState() => _ReviewOrdersViewState();
}

class _ReviewOrdersViewState extends State<ReviewOrdersView> {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: (){
                                Get.to(()=>ReviewOrderItemsScaffold());
                              },
                              child: Row(
                                children: [
                                  Text('Review Items',style: TextStyle(
