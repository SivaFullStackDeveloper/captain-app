...
class CanceledOrderDetailCardView extends StatefulWidget {

  const CanceledOrderDetailCardView({Key? key, this.title, this.quantity, this.image}) : super(key: key);
  final title;
  final quantity;
  final image;

  @override
  State<CanceledOrderDetailCardView> createState() => _CanceledOrderDetailCardViewState();
}

class _CanceledOrderDetailCardViewState extends State<CanceledOrderDetailCardView> {
