...
class PickupBottomNavBarScaffold extends StatefulWidget {

  const PickupBottomNavBarScaffold({Key? key}) : super(key: key);

  @override
  State<PickupBottomNavBarScaffold> createState() => _PickupBottomNavBarScaffoldState();
}

class _PickupBottomNavBarScaffoldState extends State<PickupBottomNavBarScaffold> {
  int _selectedIndex = 0;
  static  final List<Widget> _widgetOptions = <Widget>[
    const PickupDashboardScaffold(),
