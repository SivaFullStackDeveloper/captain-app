...
import '../../../../../../../pickupDashboard/PickupDashboardScaffold.dart';



class NotifiedToManagerScreen extends StatefulWidget {
  @override
  _NotifiedToManagerScreenState createState() => _NotifiedToManagerScreenState();
}


class _NotifiedToManagerScreenState extends State<NotifiedToManagerScreen> with RouteAware{
  @override
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                   InkWell(
                     onTap: ()=>{
                       Get.off(()=>PickupDashboardScaffold())
    },
                     child: Container(
              ...
              child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(ConstantString.notifiedToManager.tr,
