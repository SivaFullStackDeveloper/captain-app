...
class PickupReadyScreen extends StatefulWidget {
  @override
  _PickupReadyScreenState createState() => _PickupReadyScreenState();
}


class _PickupReadyScreenState extends State<PickupReadyScreen> with RouteAware{
  @override
