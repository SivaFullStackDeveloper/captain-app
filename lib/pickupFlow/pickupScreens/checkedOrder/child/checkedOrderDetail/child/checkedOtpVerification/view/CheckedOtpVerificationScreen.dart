...
import '../controller/CheckedOtpVerificationController.dart';



class CheckedOtpVerificationScreen extends StatefulWidget {
  const CheckedOtpVerificationScreen({Key? key}) : super(key: key);

  @override
  _CheckedOtpVerificationScreenState createState() => _CheckedOtpVerificationScreenState();
}


class _CheckedOtpVerificationScreenState extends State<CheckedOtpVerificationScreen> with RouteAware{

  var cancelOtpVerificationController = Get.put(CheckedOtpVerificationController());
