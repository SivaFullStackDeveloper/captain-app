...
import 'package:captain_app/pickupFlow/pickupScreens/checkedOrder/child/checkedOrderDetail/child/checkedOrderSuccessfully/CheckedOrderSuccessfullyScaffold.dart';
...
class CheckedOtpVerificationController extends GetxController{
  ...
  void handoverToManager()async{
    try{
      isLoading.value = true;
        await PostRoutes.handoverToManagerByPickupApi(id.value,videoKey.value,otp.value);

        switch (CustomObject.responseStatus) {
          case 201:
            Get.off(()=> const CheckedOrderSuccessfullyScaffold());
            break;
          case 400:
