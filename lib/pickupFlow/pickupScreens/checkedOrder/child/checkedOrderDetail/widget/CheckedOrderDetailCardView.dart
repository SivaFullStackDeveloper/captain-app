...
class CheckedOrderDetailView extends StatefulWidget {

  const CheckedOrderDetailView({Key? key, this.title, this.status, this.quantity, this.image}) : super(key: key);
  final title;
  final quantity;
  final status;
  final image;
  ...
  @override
  State<CheckedOrderDetailView> createState() => _CheckedOrderDetailViewState();
}

class _CheckedOrderDetailViewState extends State<CheckedOrderDetailView> {
