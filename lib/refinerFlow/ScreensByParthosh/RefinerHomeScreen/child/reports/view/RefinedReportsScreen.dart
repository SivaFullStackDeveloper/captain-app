...
import '../child/reportDetails/RefinedReportsDetailScaffold.dart';
import '../controller/RefinedReportsController.dart';

class RefinedReportsScreen extends StatefulWidget {
  const RefinedReportsScreen({Key? key}) : super(key: key);

  @override
  State<RefinedReportsScreen> createState() => _RefinedReportsScreenState();
}

class _RefinedReportsScreenState extends State<RefinedReportsScreen> {
  var isShow = false;
  var deliveryReportsController = Get.put(RefinedReportsController());
                  ...
                  Padding(
                    ...
                    child: ButtonWidget(
                        ...
                        press: (BuildContext context) => {
                         ...
                         Get.to(()=> RefinedReportsDetailScaffold()),
