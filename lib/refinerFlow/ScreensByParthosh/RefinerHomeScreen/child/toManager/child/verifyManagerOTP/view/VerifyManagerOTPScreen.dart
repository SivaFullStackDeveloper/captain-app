...
import 'ManagerAcceptedScreen.dart';





class VerifyManagerOtpScreen extends StatefulWidget {
  const VerifyManagerOtpScreen({Key? key}) : super(key: key);

  @override
  State<VerifyManagerOtpScreen> createState() => _VerifyManagerOtpScreenState();
}

class _VerifyManagerOtpScreenState extends State<VerifyManagerOtpScreen> {
  @override
