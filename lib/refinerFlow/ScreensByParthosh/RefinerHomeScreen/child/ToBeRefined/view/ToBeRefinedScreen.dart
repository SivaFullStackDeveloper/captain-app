...
import '../child/MeltingProcess/MeltingProcessScaffold.dart';




class ToBeRefinedScreen extends StatefulWidget {
  const ToBeRefinedScreen({super.key});

  @override
  _ToBeRefinedScreenState createState() => _ToBeRefinedScreenState();
}

class _ToBeRefinedScreenState extends State<ToBeRefinedScreen>
{
                ...
                Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        InkWell(onTap: (){
                          Get.to(()=> const MeltingProcessScaffold());
