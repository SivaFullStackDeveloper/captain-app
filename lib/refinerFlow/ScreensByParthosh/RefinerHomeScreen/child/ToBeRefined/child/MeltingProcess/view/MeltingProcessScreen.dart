...
class MeltingProcessScreen extends StatefulWidget {
  const MeltingProcessScreen({Key? key}) : super(key: key);

  @override
  State<MeltingProcessScreen> createState() => _MeltingProcessScreenState();
}

class _MeltingProcessScreenState extends State<MeltingProcessScreen> {
  @override
