...
import '../../finalCheckOrder/FinalOrderCheckScaffold.dart';



class RefinerCheckItem extends StatefulWidget {
  const RefinerCheckItem({Key? key}) : super(key: key);

  @override
  State<RefinerCheckItem> createState() => _RefinerCheckItemState();
}

class _RefinerCheckItemState extends State<RefinerCheckItem> {
  @override
              ...
              Padding(
                ...
                child: ButtonWidget(
                    ...
                    press: (BuildContext context) => {
                      Get.to(()=> FinalOrderCheckScaffold())
