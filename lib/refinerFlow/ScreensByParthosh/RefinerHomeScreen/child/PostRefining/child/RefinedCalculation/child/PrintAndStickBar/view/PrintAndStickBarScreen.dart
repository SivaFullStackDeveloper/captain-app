...
class PrintAndStickBarScreen extends StatefulWidget {
  const  PrintAndStickBarScreen({Key? key}) : super(key: key);

  @override
  State<PrintAndStickBarScreen> createState() => _PrintAndStickBarScreenState();
}

class _PrintAndStickBarScreenState extends State<PrintAndStickBarScreen> {
  @override
