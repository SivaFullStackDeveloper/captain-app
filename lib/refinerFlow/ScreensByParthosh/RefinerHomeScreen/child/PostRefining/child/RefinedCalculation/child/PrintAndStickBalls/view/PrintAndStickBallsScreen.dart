...
import '../../finalSubmisssion/FinalSubmissionScaffold.dart';





class PrintAndStickBallsScreen extends StatefulWidget {
  const  PrintAndStickBallsScreen({Key? key}) : super(key: key);

  @override
  State<PrintAndStickBallsScreen> createState() => _PrintAndStickBallsScreenState();
}

class _PrintAndStickBallsScreenState extends State<PrintAndStickBallsScreen> {
  @override
            ...
            children: [
              ...
              Column(
                children: [
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              CameraCaptureMessage(
                                scan:false,
                                title: "Take photo of Balls on Weighing Scale",
                              )
                              // : ShowImage(
                              //     title: "Id of agent",
                  ...
                  VerifierCustomTextFormFeild3(
                    labeltext: 'ENTER WEIGHT of GOLD BALLS',
              ...
              Column(
                children: [
                  ...
                  VerifierCustomTextFormFeild3(
                    labeltext: 'ENTER PURITY of GOLD BALL',
                    hintText:'Enter Number',
                    sufixText: '%',
                  ),
                ],
              ...
              Padding(
                padding: EdgeInsets.symmetric(vertical: SizeConfig.defaultSize * Dimens.size2),
                child: ButtonWidget(
                    text: 'CONTINUE',
                    fontSize: 20,
                    minWidth: SizeConfig.defaultSize*Dimens.size30,
                    ...
                    isChecked: true,
                    press: (BuildContext context){
                      Get.to(()=> FinalSubmissionScaffold());
                    }
                ),
              )
            ],
