...
class GoldBarOrderList extends StatefulWidget {
  const GoldBarOrderList({Key? key}) : super(key: key);

  @override
  State<GoldBarOrderList> createState() => _GoldBarOrderListState();
}

class _GoldBarOrderListState extends State<GoldBarOrderList> {
  @override
