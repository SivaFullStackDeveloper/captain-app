...
class PurchaseInvoiceTemplate extends StatefulWidget {
  const PurchaseInvoiceTemplate({Key? key}) : super(key: key);

  @override
  State<PurchaseInvoiceTemplate> createState() => _PurchaseInvoiceTemplateState();
}

class _PurchaseInvoiceTemplateState extends State<PurchaseInvoiceTemplate> {
  @override
