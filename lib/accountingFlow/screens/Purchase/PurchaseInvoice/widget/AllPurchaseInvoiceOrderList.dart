import 'package:captain_app/accountingFlow/screens/Purchase/PurchaseInvoice/child/PurchaseInvoicePreviewScreen/PurchaseInvoicePreviewScreenScffold.dart';
...
class AllPurchaseInvoiceOrderList extends StatefulWidget {
  const AllPurchaseInvoiceOrderList({Key? key}) : super(key: key);

  @override
  State<AllPurchaseInvoiceOrderList> createState() => _AllPurchaseInvoiceOrderListState();
}

class _AllPurchaseInvoiceOrderListState extends State<AllPurchaseInvoiceOrderList> {
  @override
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, var index) {
          ...
          return Padding(
              ...
              child: InkWell(
                onTap: () {
                  Get.to(()=>PurchaseInvoicePreviewScreenScaffold());
                },
                child: Container(
