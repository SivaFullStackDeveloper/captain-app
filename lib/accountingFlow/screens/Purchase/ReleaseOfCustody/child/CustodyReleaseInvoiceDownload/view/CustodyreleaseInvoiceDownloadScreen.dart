...
import '../../../../controller/PurchaseToggleController.dart';




class CustodyReleaseInvoiceDownloadScreen extends StatefulWidget {
  const CustodyReleaseInvoiceDownloadScreen({Key? key}) : super(key: key);

  @override
  State<CustodyReleaseInvoiceDownloadScreen> createState() => _CustodyReleaseInvoiceDownloadScreenState();
}

class _CustodyReleaseInvoiceDownloadScreenState extends State<CustodyReleaseInvoiceDownloadScreen> {

  var purchaseToggleController = Get.put(PurchaseToggleController());
              ...
              Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(!purchaseToggleController.isToggled.value? "Custody Given to Yuvaraj": ConstantString.invoiceNumber.tr,style: TextStyle(
                ...
                child: Row(
                  ...
                  children: [
                    Text("Custody Certificate",style: TextStyle(
                      fontFamily: !purchaseToggleController.isToggled.value? ConstantFonts.poppinsBold:ConstantFonts.poppinsMedium,
                      fontSize: SizeConfig.defaultSize * Dimens.size1Point4,
                      color: ConstantColor.blackColor,
                    )),
                    Switch(
                      onChanged: (value){
                        purchaseToggleController.isToggled.value = !purchaseToggleController.isToggled.value;
                      },
                      value: purchaseToggleController.isToggled.value,
                    ...
                    Text("Purchase Invoice",style: TextStyle(
                      fontFamily: purchaseToggleController.isToggled.value? ConstantFonts.poppinsBold:ConstantFonts.poppinsMedium,
                      fontSize: SizeConfig.defaultSize * Dimens.size1Point4,
                      color: ConstantColor.blackColor,
                    )),
