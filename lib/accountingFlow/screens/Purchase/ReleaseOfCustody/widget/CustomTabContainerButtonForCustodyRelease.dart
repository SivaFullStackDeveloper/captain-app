...
class CustomTabContainerButtonForCustodyRelease extends StatefulWidget {

  var isPressed;
  var text ;
  CustomTabContainerButtonForCustodyRelease({Key? key,this.text,required this.isPressed}) : super(key: key);

  @override
  State<CustomTabContainerButtonForCustodyRelease> createState() => _CustomTabContainerButtonForCustodyReleaseState();
}

class _CustomTabContainerButtonForCustodyReleaseState extends State<CustomTabContainerButtonForCustodyRelease> {
  @override
