import 'package:captain_app/accountingFlow/screens/Sale/NoteOfCustody/child/CustodyGivenScreen/widget/CustodyGivenOrderList.dart';
...
class CustodyGivenScreen extends StatefulWidget {
  var name;
  CustodyGivenScreen({Key? key,required this.name}) : super(key: key);

  @override
  State<CustodyGivenScreen> createState() => _CustodyGivenScreenState();
}

class _CustodyGivenScreenState extends State<CustodyGivenScreen> {
    ...
    return SafeArea(
      child: Column(
        children: [
          ...
          Expanded(child: CustodyGivenOrderList()),
