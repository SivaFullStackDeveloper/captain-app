import 'package:captain_app/accountingFlow/screens/Sale/NoteOfCustody/widget/AllClientCustodyGivenList.dart';
...
import '../widget/CustomTabConatinerButtonForCustody.dart';



class NoteOfCustodyScreen extends StatefulWidget {
  const NoteOfCustodyScreen({Key? key}) : super(key: key);

  @override
  State<NoteOfCustodyScreen> createState() => _NoteOfCustodyScreenState();
}

class _NoteOfCustodyScreenState extends State<NoteOfCustodyScreen> {
  var allTab = true;
    ...
    return SafeArea(
      child: Column(
        children: [
          Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(ConstantString.custodyGiven.tr,style: TextStyle(
          ...
          Row(
            children: [
              ...
              InkWell(
                ...
                child: CustomTabContainerButtonForCustody(
                    isPressed:allTab,
                    text:'All'
                ),
              ),
          ...
          Expanded(child: AllClientCustodyGivenOrderList()),
