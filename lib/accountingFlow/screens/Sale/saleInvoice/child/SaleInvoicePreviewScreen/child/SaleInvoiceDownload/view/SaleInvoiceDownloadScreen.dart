...
class SaleInvoiceDownloadScreen extends StatefulWidget {
  const SaleInvoiceDownloadScreen({Key? key}) : super(key: key);

  @override
  State<SaleInvoiceDownloadScreen> createState() => _SaleInvoiceDownloadScreenState();
}

class _SaleInvoiceDownloadScreenState extends State<SaleInvoiceDownloadScreen> {
