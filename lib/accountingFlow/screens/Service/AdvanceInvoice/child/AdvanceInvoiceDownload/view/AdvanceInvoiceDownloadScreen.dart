...
class AdvanceInvoiceDownloadScreen extends StatefulWidget {
  const AdvanceInvoiceDownloadScreen({Key? key}) : super(key: key);

  @override
  State<AdvanceInvoiceDownloadScreen> createState() => _AdvanceInvoiceDownloadScreenState();
}

class _AdvanceInvoiceDownloadScreenState extends State<AdvanceInvoiceDownloadScreen> {
