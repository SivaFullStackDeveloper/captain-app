...
class ManagerCustomBoxForReports extends StatefulWidget {
  Function(BuildContext context) press;
  var icon;
  var text;
  ManagerCustomBoxForReports({Key? key,required this.press,required this.icon,this.text}) : super(key: key);

  @override
  State<ManagerCustomBoxForReports> createState() => _ManagerCustomBoxForReportsState();
}

class _ManagerCustomBoxForReportsState extends State<ManagerCustomBoxForReports> {
  @override
