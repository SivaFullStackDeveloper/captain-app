...
class VerifiedCardView extends StatefulWidget {

   VerifiedCardView({Key? key, this.requestTime, this.id, this.orderId, this.requestDate}) : super(key: key);
  final id;
  final orderId;
  final requestDate;
  final requestTime;
  ...
  @override
  State<VerifiedCardView> createState() => _VerifiedCardViewState();
}

class _VerifiedCardViewState extends State<VerifiedCardView> {
  @override
