...
class SealedBagToSentSuccessfullyScreen extends StatefulWidget {
  const SealedBagToSentSuccessfullyScreen({Key? key}) : super(key: key);

  @override
  _SealedBagToSentSuccessfullyScreenState createState() => _SealedBagToSentSuccessfullyScreenState();
}


class _SealedBagToSentSuccessfullyScreenState extends State<SealedBagToSentSuccessfullyScreen> with RouteAware{
  @override
              ...
              child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(ConstantString.sealedBagIsSentToWarehouse.tr,
                    ...
                    Padding(
                      ...
                      child: Text(ConstantString.sealedBagIsSentToWarehouseNote.tr,
                          textAlign: TextAlign.center,
                          style: TextStyle(
                    ...
                    Padding(
                      ...
                      child: ButtonWidget(
                          text:  "Check other orders".toUpperCase().tr,
                          fontSize: SizeConfig.defaultSize * Dimens.size1Point5,
                          minWidth: SizeConfig.screenWidth,
                          minHeight: SizeConfig.defaultSize * Dimens.size5,
                          isChecked:  true,
                          press: (BuildContext context) => {
                             Get.off(()=> const SendToWarehouseScaffold())
                          }),
                    )
                  ]
              ),
