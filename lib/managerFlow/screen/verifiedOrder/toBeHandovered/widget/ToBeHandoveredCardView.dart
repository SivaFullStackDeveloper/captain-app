...
import '../child/ToBeHandoveredDetail/ToBeHandoveredDetailScaffold.dart';

class ToBeHandoveredCardView extends StatefulWidget {

  ToBeHandoveredCardView({Key? key, this.verifyTime, this.id, this.orderId, this.verifyDate}) : super(key: key);
  final id;
  final orderId;
  final verifyTime;
  final verifyDate;
  ...
  @override
  State<ToBeHandoveredCardView> createState() => _ToBeHandoveredCardViewState();
}

class _ToBeHandoveredCardViewState extends State<ToBeHandoveredCardView> {
  @override
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: ()=> {
          ...
          Get.to(()=>  const ToBeHandoveredDetailScaffold(),arguments: [
            {"id": widget.id},
