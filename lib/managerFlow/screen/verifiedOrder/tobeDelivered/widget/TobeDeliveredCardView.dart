...
class TobeDeliveredCardView extends StatefulWidget {
  ...
  TobeDeliveredCardView({Key? key, this.verifyTime, this.id, this.orderId, this.verifyDate}) : super(key: key);
  final id;
  final orderId;
  final verifyTime;
  final verifyDate;
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text("Verified Time: " + widget.formattedVerifyTime.toString() , style: TextStyle(
                              fontFamily: ConstantFonts
                                  .poppinsRegular,
                              fontSize: SizeConfig
                                  .defaultSize *
