...
class ToBeAssignedDetailCardView extends StatefulWidget {
  ToBeAssignedDetailCardView(
  ...
  @override
  State<ToBeAssignedDetailCardView> createState() => _ToBeAssignedDetailCardViewState();
}

class _ToBeAssignedDetailCardViewState extends State<ToBeAssignedDetailCardView> {
  var reviewOrdersController = Get.put(ToBeAssignedDetailController());
