...
class ToBeAssignedOtpVerificationScaffold extends StatelessWidget {
  const ToBeAssignedOtpVerificationScaffold({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ToBeAssignedOtpVerificationScreen(),
    );
  }
}
