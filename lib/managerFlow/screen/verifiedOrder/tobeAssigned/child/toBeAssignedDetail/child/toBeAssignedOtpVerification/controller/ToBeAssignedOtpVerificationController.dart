...
class ToBeAssignedOtpVerificationController extends GetxController{
  ...
  void handoverToVerifierCaptain()async{
    try{
      ...
      await PostRoutes.handoverToVerifierCaptain(id.value,captain.value,otp.value);

      switch (CustomObject.responseStatus) {
        case 201:
          print("==========>>>> END  DONE " );
          Get.off(()=> const ToBeAssignedSuccessfullyScaffold());
          break;
        case 400:
