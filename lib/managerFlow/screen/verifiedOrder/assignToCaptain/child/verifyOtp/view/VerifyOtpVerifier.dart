...
import '../child/customerNotifiedAssigning/CustomerNotifiedAssigningScaffold.dart';


class VerifyOtpVerifier extends StatefulWidget {
  const VerifyOtpVerifier({Key? key}) : super(key: key);

  @override
  State<VerifyOtpVerifier> createState() => _VerifyOtpVerifierState();
}

class _VerifyOtpVerifierState extends State<VerifyOtpVerifier> {
  @override
                ...
                children: [
                  ...
                  ButtonWidget(
                    ...
                    press: (BuildContext context) {
                      Get.to(() => CustomerNotifiedAssigningScaffold());
