...
class SealedBagSuccessfullyScreen extends StatefulWidget {
  const SealedBagSuccessfullyScreen({Key? key}) : super(key: key);

  @override
  _SealedBagSuccessfullyScreenState createState() => _SealedBagSuccessfullyScreenState();
}


class _SealedBagSuccessfullyScreenState extends State<SealedBagSuccessfullyScreen> with RouteAware{
  @override
              ...
              child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("Once your limit is matched all the sealed bags will leave the warehouse automatically ".tr,
                          textAlign: TextAlign.center,
                          style: TextStyle(
