...
import 'package:captain_app/managerFlow/screen/refinedOrder/tobeReceived/child/toBeAssignedDetail/child/orderReadyBeRefinedSuccessfully/OrderReadyBeRefinedSuccessfullyScaffold.dart';
...
import '../controller/TobeReceivedOtpVerificationController.dart';



class TobeReceivedOtpVerificationScreen extends StatefulWidget {
  const TobeReceivedOtpVerificationScreen({Key? key}) : super(key: key);

  @override
  _TobeReceivedOtpVerificationScreenState createState() => _TobeReceivedOtpVerificationScreenState();
}


class _TobeReceivedOtpVerificationScreenState extends State<TobeReceivedOtpVerificationScreen> with RouteAware{

  var cancelOtpVerificationController = Get.put(ToBeAssignedOtpVerificationController());
                    ...
                    Padding(
                      ...
                      child: ButtonWidget(
                          ...
                          press: (BuildContext context) => {
                            Get.to(()=> OrderReadyBeRefinedSuccessfullyScaffold())
