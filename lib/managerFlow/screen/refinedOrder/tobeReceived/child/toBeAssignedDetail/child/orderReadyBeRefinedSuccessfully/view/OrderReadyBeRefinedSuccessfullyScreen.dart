...
class OrderReadyBeRefinedSuccessfullyScreen extends StatefulWidget {
  const OrderReadyBeRefinedSuccessfullyScreen({Key? key}) : super(key: key);

  @override
  _OrderReadyBeRefinedSuccessfullyScreenState createState() => _OrderReadyBeRefinedSuccessfullyScreenState();
}


class _OrderReadyBeRefinedSuccessfullyScreenState extends State<OrderReadyBeRefinedSuccessfullyScreen> with RouteAware{
  @override
              ...
              child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(ConstantString.orderReadyBeRefined.tr,
                    ...
                    Padding(
                      ...
                      child: Text(ConstantString.orderReadyBeRefinedNote.tr,
                          textAlign: TextAlign.center,
                          style: TextStyle(
