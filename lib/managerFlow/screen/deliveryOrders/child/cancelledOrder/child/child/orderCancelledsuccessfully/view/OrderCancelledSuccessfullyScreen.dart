...
import 'package:captain_app/managerFlow/screen/deliveryOrders/child/cancelledOrder/CancelledOrderScaffold.dart';
...
class OrderCancelledSuccessfullyScreen extends StatefulWidget {
  @override
  _OrderCancelledSuccessfullyScreenState createState() => _OrderCancelledSuccessfullyScreenState();
}


class _OrderCancelledSuccessfullyScreenState extends State<OrderCancelledSuccessfullyScreen> with RouteAware{
  @override
                ...
                mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("Complete order got canceled".tr,
                    ...
                    Padding(
                      ...
                      child: Text("Return entire items to the store".tr,
                          textAlign: TextAlign.center,
                          style: TextStyle(
                    ...
                    Padding(
                      ...
                      child: ButtonWidget(
                          text:  "Check other canceled orders".toUpperCase().tr,
                          fontSize: SizeConfig.defaultSize * Dimens.size1Point5,
                          minWidth: SizeConfig.screenWidth,
                          minHeight: SizeConfig.defaultSize * Dimens.size5,
                          isChecked:  true,
                          press: (BuildContext context) => {
                             Get.off(()=> const CancelledOrderScaffold())
                          }),
                    )
                  ]
              ),
