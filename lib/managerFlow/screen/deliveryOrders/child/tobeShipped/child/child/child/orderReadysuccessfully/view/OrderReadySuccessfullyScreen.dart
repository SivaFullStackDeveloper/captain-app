...
import '../../../../../TobeShippedScaffold.dart';



class OrderReadySuccessfullyScreen extends StatefulWidget {
  const OrderReadySuccessfullyScreen({super.key});

  @override
  _OrderReadySuccessfullyScreenState createState() => _OrderReadySuccessfullyScreenState();
}


class _OrderReadySuccessfullyScreenState extends State<OrderReadySuccessfullyScreen> with RouteAware{
  @override
