...
class TransitOrderDetails extends StatefulWidget {
  const TransitOrderDetails({Key? key}) : super(key: key);

  @override
  State<TransitOrderDetails> createState() => _TransitOrderDetailsState();
}

class _TransitOrderDetailsState extends State<TransitOrderDetails> {
  @override
