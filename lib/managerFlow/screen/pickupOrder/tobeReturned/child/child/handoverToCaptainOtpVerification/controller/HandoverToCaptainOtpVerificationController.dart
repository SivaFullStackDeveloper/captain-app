...
import '../../orderReadyToPackedsuccessfully/OrderReadyToPackedSuccessfullyScaffold.dart';
import '../HandoverToCaptainOtpVerificationScaffold.dart';



class HandoverToCaptainOtpVerificationController extends GetxController{
  ...
  void handoverToPickupCaptain()async{
    try{
      isLoading.value = true;
        await PostRoutes.handoverOrderToPickupCaptain(id.value,captain.value,otp.value);

        switch (CustomObject.responseStatus) {
          case 201:
            print("==========>>>> END  " );
            Get.off(()=> const OrderReadyToPackedSuccessfullyScaffold());
            break;
          case 400:
