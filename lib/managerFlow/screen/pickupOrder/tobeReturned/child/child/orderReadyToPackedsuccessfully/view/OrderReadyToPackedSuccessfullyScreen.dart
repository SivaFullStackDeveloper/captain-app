...
import 'package:captain_app/managerFlow/screen/pickupOrder/tobeReturned/ToBeReturnedScaffold.dart';
...
class OrderReadyToPackedSuccessfullyScreen extends StatefulWidget {
  const OrderReadyToPackedSuccessfullyScreen({super.key});

  @override
  _OrderReadyToPackedSuccessfullyScreenState createState() => _OrderReadyToPackedSuccessfullyScreenState();
}


class _OrderReadyToPackedSuccessfullyScreenState extends State<OrderReadyToPackedSuccessfullyScreen> with RouteAware{
  @override
                ...
                mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("Order ready be packed".tr,
                    ...
                    Padding(
                      ...
                      child: Text("Order handover to delivery captain, ready to be packed".tr,
                          textAlign: TextAlign.center,
                          style: TextStyle(
