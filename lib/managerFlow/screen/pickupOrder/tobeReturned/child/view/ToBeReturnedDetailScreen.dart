...
import '../widget/ToBeReturnedDetailCardView.dart';


class ToBeReturnedDetailScreen extends StatefulWidget {
  const ToBeReturnedDetailScreen({super.key});

  @override
  _ToBeReturnedDetailScreenState createState() => _ToBeReturnedDetailScreenState();
}

class _ToBeReturnedDetailScreenState extends State<ToBeReturnedDetailScreen> with RouteAware {
  var toBeReturnedDetailController = Get.put(ToBeReturnedDetailController());
  @override
  Widget build(BuildContext context) {
    return Obx(() => toBeReturnedDetailController.isLoading.value
        ? const CustomProgressIndicator()
        : SafeArea(
      child: SingleChildScrollView(
        physics: const BouncingScrollPhysics(),
        child: Obx(() => toBeReturnedDetailController.isLoading.value
            ? const CustomProgressIndicator()
            : Padding(
          ...
          child: Column(children: [
            ...
            ///------------------- Action Bar ---------------------
            ActionBar(title: "Order # " + toBeReturnedDetailController.orderId.value,),
            ...
            Column(
                ...
                children: [
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: toBeReturnedDetailController.allToBeReturnedDeliveryLength.value != 0
                                            ? ListView.builder(
                                          scrollDirection: Axis.vertical,
                                          itemCount: toBeReturnedDetailController.allToBeReturnedDeliveryItemsList.length,
                                          physics: const BouncingScrollPhysics(),
                                          shrinkWrap: true,
                                          itemBuilder: (context, index) {
                                            var item = toBeReturnedDetailController.allToBeReturnedDeliveryItemsList[index];
                                            return ToBeReturnedDetailCardView(
                                              index: index,
                                              title: item.title,
                                        ...
                                        child: Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: DropdownButton<String>(
                                              ...
                                              value: toBeReturnedDetailController.dropdownValue.value.isNotEmpty
                                                  ? toBeReturnedDetailController.dropdownValue.value
                                                  : null,
                                              ...
                                              onChanged: (String? data) {
                                                toBeReturnedDetailController.dropdownValue.value = data!;
                                                var index = toBeReturnedDetailController.captainNameList.indexOf(data);
                                                toBeReturnedDetailController.captainId.value = toBeReturnedDetailController.captainIdList[index];

                                              },
                                              items: toBeReturnedDetailController.captainNameList.value
                  ...
                  Padding(
                    ...
                    child: ButtonWidget(
                        text:  "Handover to Pickup captain".tr,
                        fontSize: SizeConfig.defaultSize * Dimens.size1Point5,
                        ...
                        press: (BuildContext context) => {
                          ...
                          toBeReturnedDetailController.sendOtpToDeliveryCaptainCaptainFunction()
