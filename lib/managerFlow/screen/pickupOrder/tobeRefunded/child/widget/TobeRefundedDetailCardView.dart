...
class TobeRefundedDetailCardView extends StatefulWidget {

  const TobeRefundedDetailCardView({Key? key, this.title, this.quantity, this.image, this.status}) : super(key: key);
  final title;
  final quantity;
  final image;
  final status;
  ...
  @override
  State<TobeRefundedDetailCardView> createState() => _TobeRefundedDetailCardViewState();
}

class _TobeRefundedDetailCardViewState extends State<TobeRefundedDetailCardView> {
